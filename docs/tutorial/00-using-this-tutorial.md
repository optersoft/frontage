...
Each of the examples in this tutorial can be run on PyScript.com, a web environment that lets you write, test, and share PyScript code. Alternatively, you can clone the [Frontage git repo](https://github.com/optersoft/frontage) and run a live web server with each example included.

The PyScript.com environment uses the Frontage `.whl` file, as [downloadable from PyPi](https://pypi.org/project/frontage/#files), while the examples in the git repository are served with Frontage directly from source files on disk.
...
After cloning [frontage on git](https://github.com/optersoft/frontage), you can run the examples using a simple script:

![CleanShot 2024-06-30 at 10.52.57@2x.png](../images/frontage-examples-terminal.png)

http://localhost:8000/ show you a list of examples

![CleanShot 2024-06-30 at 10.54.52@2x.png](../images/frontage-localhost-browser.png)
