...
> **Status: 0.4.1, alpha.** The rewrite planned in [DESIGN.md](DESIGN.md) is complete through
...
```json
{ "packages": ["https://frontage.optersoft.com/dist/frontage-0.4.1-py3-none-any.whl"] }
```
