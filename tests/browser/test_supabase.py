...
from frontage.supabase import Channel, Client, PostgrestError
...
def app(tmp_path_factory):
    ...
    handler.extensions_map = {  # ty: ignore[unresolved-attribute]
...
def test_the_whole_component_against_a_server_that_speaks_postgrest_and_phoenix(app, page: Page):
    stub = Stub()
    stub.start()
    errors = []
