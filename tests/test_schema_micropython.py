...
out["repr"] = repr(from_json_schema(User.json_schema())) == repr(User)
...
def test_the_package_runs_on_the_shipped_micropython(tmp_path):
    ...
    rows = [{"id": i, "name": "n%d" % i, "email": "u%d@example.com" % i, "when": "2026-09-07T21:17:05+02:00", "uid": "123e4567-e89b-12d3-a456-426614174000"} for i in range(50)]
    rows[0]["age"] = 30
