...
from frontage_table import STYLESHEET, Column, table
...
def test_the_shipped_stylesheet_matches_the_source():
    ...
    import frontage_table

    shipped = Path(frontage_table.__file__).parent / "_browser" / "index.css"
...
def test_the_raw_value_is_what_sorting_compares():
    from frontage_table import Column
